...
```mermaid
flowchart TD
    A["README — scope & disclaimers"] --> B["01 · Campaign Plan\n(strategy, vote goal, budget, org)"]
    B --> C["02 · Compliance & Filing\n(FEC committee, limits, reporting calendar)"]
    B --> D["03 · Fundraising Plan\n(goals, call time, online, events)"]
    B --> E["04 · Messaging & Issues\n(message box, stump, contrast)"]
    B --> F["05 · Field & GOTV\n(targeting, canvass, ballot chase)"]
    C --> G["06 · 7-Week Execution Calendar\n(ties everything to dates)"]
    D --> G
    E --> G
    F --> G
    G --> H["07 · Sample Artifacts\n(ready-to-send documents)"]
```
